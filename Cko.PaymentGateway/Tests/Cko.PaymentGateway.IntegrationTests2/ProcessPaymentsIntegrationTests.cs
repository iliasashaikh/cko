...
{
    public class BankSdkProcessPaymentsTest : IBankSdk
    {
    ...
    [TestFixture]
    public class ProcessPaymentsIntegrationTests
    {
        ...
        // Create a one time setup for Test factory to be resused by all Tests
        [OneTimeSetUp]
                                ...
                                .WithWebHostBuilder(builder =>
                                    {
                                        ...
                                        {
                                            services.AddScoped<Func<string, IBankSdk>>(s => (u) => new BankSdkProcessPaymentsTest());
                                        });
